...
public class DubboConfigConfiguration {
     ...
     * EnableConfigurationBeanBindings 中带上的 import 注解，会执行 ConfigurationBeanBindingsRegister#registerBeanDefinitions方法
     * 这个方法，会获取到 EnableConfigurationBeanBinding 注解数组，依次在 Spring的容器中注入 ApplicationConfig，ModuleConfig 等类
     * 这些类在注入的过程中会从配置文件中去读取相关的数据 并注入到对应的属性中去
     */
